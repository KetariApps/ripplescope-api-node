...
const land: ScopeCreateInput = {
  ...
  description: `Land, the foundation of terrestrial ecosystems, plays a critical role in supporting biodiversity, mitigating climate change, and ensuring sustainable livelihoods. This initiative places land conservation and responsible land management at its core, acknowledging their significance in safeguarding ecological health.
      ...
      Continuous assessment during the initiative's full operation is essential to monitor and address any environmental degradation on the site. This ongoing evaluation determines whether the project has successfully minimized or inadvertently caused further degradation. It allows for operational adjustments to enhance ecological benefits and reduce harm.
  
      If the project or program necessitates the acquisition of arable land, this decision comes with implications. Converting such land can disrupt local food systems, potentially leading to food insecurity and biodiversity loss. However, if the project focuses on ecological restoration, acquiring arable land can contribute to sustainability and support environmental goals.
  
      Overall, this initiative prioritizes an awareness of these factors and their integration into the project's planning and operation. By doing so, it aims to achieve better environmental outcomes, benefiting both the local ecology and communities while ensuring the overall success of the initiative.
      `,
  considerations: {
    Stakeholder: {
      connectOrCreate: [
      ...
      create: [
        {
          node: {
            ...
            description:
              'This question explores the condition and history of the site before project initiation.',
          },
        },
        {
          node: {
            ...
            description:
              "This question assesses the site's expected condition during full project operation.",
          },
        },
        {
          node: {
            ...
            description:
              'This question examines the implications of acquiring arable land for the project or program.',
          },
        },
      ],
    },
