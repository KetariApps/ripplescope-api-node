      ...
      create: [
        {
          node: {
            brief:
              'How does the initiative/organization assess and monitor the impact of its activities on ocean ecosystems and marine life?',
            description:
              "This question explores the initiative/organization's approach to assessing and monitoring its impact on ocean ecosystems.",
          },
        },
        {
          node: {
            brief:
              'Does the initiative/organization have activities aimed at restoring or preserving marine and coastal habitats, such as coral reefs, mangrove forests, seagrass beds, or coastal wetlands?',
            description:
              "This question focuses on the initiative/organization's efforts to restore or preserve critical marine and coastal habitats.",
          },
        },
        {
          node: {
            brief:
              'How does the initiative/organization address potential threats to marine biodiversity, such as overexploitation of marine resources, habitat destruction, or pollution?',
            description:
              "This question examines the initiative/organization's strategies for addressing threats to marine biodiversity.",
          },
        },
        {
          node: {
            brief:
              "Does the initiative/organization run or support measures to protect endangered or vulnerable marine species and their habitats from the organization's activities?",
            description:
              "This question assesses the initiative/organization's protection measures for endangered or vulnerable marine species.",
          },
        },
        {
          node: {
            brief:
              'Does the initiative/organization involve fishing practices, aquaculture, harvesting/removal of marine resources, or discharging waste into coastal waters? If so, how does the initiative/organization address the potential risk of ocean resource depletion due to its activities, such as extraction, aquaculture, or waste discharge?',
            description:
              "This question explores the initiative/organization's engagement in activities that may impact ocean resources and its mitigation efforts.",
          },
        },
        {
          node: {
            brief:
              'How many initiative/organization activities are aimed at improving resilience in coastal areas or populations, considering the potential impacts of climate change and sea-level rise?',
            description:
              "This question focuses on the initiative/organization's efforts to enhance coastal resilience in the face of climate change and sea-level rise.",
          },
        },
        {
          node: {
            ...
            description:
              "This question examines the initiative/organization's educational initiatives and awareness campaigns related to ocean conservation.",
          },
        },
        {
          node: {
            brief:
              'Does the initiative/organization involve activities that use or promote ocean energy systems (e.g., tidal, wave, or offshore wind energy)? If so, how are potential environmental impacts on marine ecosystems mitigated?',
            description:
              "This question explores the initiative/organization's involvement in ocean energy systems and its efforts to mitigate environmental impacts.",
          },
        },
        {
          node: {
            ...
            description:
              "This question focuses on the initiative/organization's engagement with local communities and stakeholders in marine resource and ecosystem conservation.",
          },
        },
      ],
    },
