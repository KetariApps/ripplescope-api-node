      ...
      create: [
        {
          node: {
            brief:
              'What types of man-made waste material, including technological/e-waste, does the initiative/organization create through its activities? Is any of this material considered hazardous or harmful to people or the environment in any way? If so, how, and what efforts are being made to address this?',
            description:
        ...
        },
        {
          node: {
            brief:
              'Does this initiative/organization involve the extensive use of glass or other recyclable/reusable materials to reduce the generation of non-recyclable waste?',
            description:
        ...
        },
        {
          node: {
            brief:
              'Does this initiative/organization involve the use of single-use plastics or other non-biodegradable materials? If so, how are efforts made to minimize their use or promote sustainable alternatives?',
            description:
        ...
        },
        {
          node: {
            brief:
              'What is the quantity and ratio of recyclable and non-recyclable waste generated through the initiative/organization’s activities per month/year?',
            description:
        ...
        },
        {
          node: {
            brief:
              'How does the initiative/organization minimize its non-recyclable waste production, and what waste reduction strategies are in place?',
            description:
        ...
        },
        {
          node: {
            brief:
              'What recycling measures/activities does the initiative/organization undertake to ensure proper management of recyclable materials?',
            description:
        ...
        },
        {
          node: {
            brief:
              'How does the initiative/organization support the circular economy by incorporating waste reduction, reuse, and recycling practices into its operations?',
            description:
        ...
        },
        {
          node: {
            brief:
              'Does the initiative/organization partner with any specialist organizations or bodies related to waste reduction, reuse, or recycling to enhance its waste management practices?',
            description:
        ...
        },
        {
          node: {
            brief:
              'How does the initiative/organization evaluate and monitor the effectiveness of its waste management practices in reducing both recyclable and non-recyclable waste?',
            description:
