...
const ecological: ScopeCreateInput[] = [
  {
    name: 'AIR POLLUTION',
    brief:
  ...
  },
  {
    ...
    basis:
      'It assesses measures to protect the ozone layer and mitigate its depletion, recognizing its role in safeguarding human and environmental health.',
  },
  {
  ...
  {
    name: 'NITROGEN AND PHOSPHOROUS LOADING',
    brief:
      'Managing nutrient inputs into ecosystems to avoid excessive nutrient enrichment and related environmental problems.',
    basis:
      'It considers the potential for nutrient loading to disrupt ecosystem balance and affect both human well-being and ecological integrity.',
  },
  {
    ...
    basis:
      'It evaluates the management of recyclable materials and waste, considering their impact on resource depletion and environmental health.',
  },
  {
    name: 'SUPPLY CHAIN',
    brief:
